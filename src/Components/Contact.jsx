...
const Contact = () => {
  return (
    <div name='contact' className='w-full min-h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col justify-center items-center max-w-screen-lgh-full'>
            <div className='max-w-screen-lg mx-auto'>
                ...
                <div className='flex justify-center items-center'>
                    <form action="https://getform.io/f/lbjkmgpa" method='POST' className='flex flex-col w-full'>
                        ...
                        <textarea name="message" rows="10" placeholder='Enter your message' className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none mb-4'></textarea>
